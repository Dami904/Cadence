...
function Feature({ number, icon, title, text }: { number: string; icon: React.ReactNode; title: string; text: string }) { return <article className="how-card"><span>{number}</span><div className="how-icon">{icon}</div><h3>{title}</h3><p>{text}</p></article>; }
